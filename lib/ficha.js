...
(function () {
  ...
  function etiquetaTipo(t) { return t === "camiseta" ? "Camiseta" : "Zapas"; }
  ...
  function plantilla(p, esAdmin) {
    ...
    var guia = (marca().guias || {})[p.tipo === "camiseta" ? "camiseta" : "zapas"] || null;
    ...
    var medidas = guia
      ? '<table class="medidas"><thead><tr><th>Talla</th><th>' +
        (p.tipo === "camiseta" ? "Pecho × largo" : "Plantilla") +
        "</th></tr></thead><tbody>" +
